...
class out_ncurses {
	...
	public function __construct($info, $settings) {
	...
	// Handle the shit
	public function work($info, $settings) {
		...
		ncurses_mvwaddstr($fullscreen, 0, 0, 'Generated by Linfo on '.date('m/d/Y @ h:i:s A (T)'));
		ncurses_wrefresh($fullscreen);
	...
	// Get usable dimensions of current screen
	private function _get_max_dim() {
		return array($x, $y);
	}
